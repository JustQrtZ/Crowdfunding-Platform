...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseProject.Model.Entities.Comments", b =>
                {
                    ...
                    b.Property<string>("CompanyNewsId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CourseProject.Model.Entities.CompanyTags", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CourseProject.Model.Entities.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CourseProject.Model.Entities.Tags", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CourseProject.Model.Entities.Comments", b =>
                {
                    b.HasOne("CourseProject.Model.Entities.CompanyNews", "CompanyNews")
                        .WithMany()
                        .HasForeignKey("CompanyNewsId")
            ...
            modelBuilder.Entity("CourseProject.Model.Entities.CompanyTags", b =>
                {
                    ...
                    b.HasOne("CourseProject.Model.Entities.Tags", "Tags")
                        .WithMany()
            ...
            modelBuilder.Entity("CourseProject.Model.Entities.User", b =>
                {
                    b.HasOne("CourseProject.Model.Entities.Role", "Role")
                        .WithMany()
